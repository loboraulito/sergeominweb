      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <button class="btn btn-default btn-success" onclick="window.location.href = '<?php echo site_url('recepcionista/solicitud_analisis_lq/wizard_solicitud');?>';">Nuevo</button>
